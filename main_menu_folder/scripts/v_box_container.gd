...
var sound1 = preload("res://main_menu_folder/audios/click-buttons-ui-menu-sounds-effects-button-13-205396.mp3")  # Hover
var sound2 = preload("res://main_menu_folder/audios/computer-processing-sound-effects-short-click-select-01-122134.mp3")  # Pressed
